...
Features_Off = [
                ...% Color CCT
                cct_std_F, cct_skew_F, cct_kurt_F, cct_entropy_F,  ...    % 
                ...
                cct_portion_16_F,cct_portion_17_F,                 cct_portion_19_F,cct_portion_20_F,   ...    %+20     
                        ...% Color CCT
                cct_std_B, cct_skew_B, cct_kurt_B, cct_entropy_B, ...    %   
...
case 'sat',
  Features_Off =  [   ...   % Foreground      Remove portion_18 for fixing rank-deficiency
                sat_std_F, sat_skew_F, sat_kurt_F, sat_entropy_F,  ...   %+4    
                ...
                sat_portion_16_F,sat_portion_17_F,               sat_portion_19_F,sat_portion_20_F,   ... %+20    
                    ...   % Background
                 sat_std_B, sat_skew_B, sat_kurt_B, sat_entropy_B,  ...   %+4     
...
case 'hue',
Features_Off =  [   ...   % Foreground
                 hue_std_F, hue_skew_F, hue_kurt_F, hue_entropy_F, ...        %+4   Remove one portion to fix rank-deficiency
                ...
                hue_portion_06CCW_F,hue_portion_07CCW_F,                    hue_portion_09CCW_F,hue_portion_10CCW_F,   ... %+20  
                    ...  % Background
                hue_std_B, hue_skew_B, hue_kurt_B, hue_entropy_B, ...        %+4   
